...
fun MultiFloatingActionButton(
    ...
    val rotation: Float by stateTransition.animateFloat(
        ...
        if (state == MultiFabState.EXPANDED) 0f else 45f
    }
            ...
            Column(
                ...
                FloatingActionButton(
                    ...
                    shape = RoundedCornerShape(
                        topStart = if (currentState == MultiFabState.EXPANDED) 30.dp else 0.dp,
                        topEnd = 30.dp,
                        bottomStart = 30.dp,
                        bottomEnd = if (currentState == MultiFabState.EXPANDED) 0.dp else 30.dp,
                    ),
                    containerColor = MaterialTheme.color.bodyTextColor,
                    onClick = {
                        stateChange()
                    }) {
                    Icon(
    ...
    Row(
        ...
        if (showLabel) {
            Text(
                ...
                color = MaterialTheme.color.bodyTextColor,
